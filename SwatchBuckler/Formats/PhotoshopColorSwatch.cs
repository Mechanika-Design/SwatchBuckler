...
namespace SwatchBuckler
{
    ...
    /// </summary>
    public class PhotoshopColorSwatchSerializer : Palette
    {
        ...
        protected virtual ColorCollection ReadPalette(Stream stream, AdobePhotoshopColorSwatchFileVersion version)
        {
            ...
            for (int i = 0; i < colorCount; i++)
            {
                ...
                if (version == AdobePhotoshopColorSwatchFileVersion.Version2)
                {
                    ...
                    // need to read the name even though currently our color collection doesn't support names
                ...
                switch (colorSpace)
                {
                    ...
                    case AdobePhotoshopColorSwatchColorSpace.Cmyk:
                        double cyan;
                        double magenta;
                        double yellow;
                        double black;
                        ...
                        cyan = 100 - (value1 / 655.35);
                        magenta = 100 - (value2 / 655.35);
                        yellow = 100 - (value3 / 655.35);
                        black = 100 - (value4 / 655.35);

                        results.Add(new CmykColor(cyan, magenta, yellow, black).ToRgbColor());
                        break;

                    case AdobePhotoshopColorSwatchColorSpace.Lab:
                        double L;
                        double a;
                        double b;
                        ...
                        results.Add(new CIELabColor(L, a, b).ToRgbColor());
                        break;
